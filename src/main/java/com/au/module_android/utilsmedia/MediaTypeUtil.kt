...
class MediaTypeUtil private constructor() {
    companion object {
        ...
        fun isUriImage(mimeType:String): Boolean {
         ...
         */
        fun filePathTo(filePath:String) : MediaType {
            return mediaTypeTo(getMimeTypePath(filePath))
        }
         ...
         */
        @Deprecated("replace with mediaTypeTo / filePathTo")
